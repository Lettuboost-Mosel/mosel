          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center opacity-0 animate-fade-in" style={{ animationFillMode: 'forwards' }}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-[30px]">
                A <span className="text-[#8FD7E5] drop-shadow-[0_0_1px_black] drop-shadow-[0_0_1px_black] drop-shadow-[0_0_1px_black] drop-shadow-[0_0_1px_black]">Web Studio</span> Built for Real-World Business Needs
              </h2>
